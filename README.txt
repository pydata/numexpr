...
portion in the resulting array.
...
- In situations where you have to perform a lot of complex
  computations with large arrays and you want maximum computational
  efficency, while consuming a minimum of memory.

- Whenever you want to add an expression parser for your application.
  For example, given arrays ``a`` and ``b``, you want to easily
  evaluate the expression given as the string "3*a+4*b".
