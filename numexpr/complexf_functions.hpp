...
/* constants */
static npy_cfloat ncf_1 = {1., 0.};
static npy_cfloat ncf_half = {0.5, 0.};
static npy_cfloat ncf_i = {0., 1.};
static npy_cfloat ncf_i2 = {0., 0.5};
/*
static npy_cfloat ncf_mi = {0., -1.};
static npy_cfloat ncf_pi2 = {M_PI/2., 0.};
*/
...
static void
ncf_assign(npy_cfloat *x, npy_cfloat *r)
{
  r->real = x->real;
  r->imag = x->imag;
  return;
...
static void
ncf_sum(npy_cfloat *a, npy_cfloat *b, npy_cfloat *r)
{
...
static void
ncf_diff(npy_cfloat *a, npy_cfloat *b, npy_cfloat *r)
{
    r->real = a->real - b->real;
    r->imag = a->imag - b->imag;
    return;
...
static void
ncf_neg(npy_cfloat *a, npy_cfloat *r)
{
    r->real = -a->real;
    r->imag = -a->imag;
    return;
...
static void
ncf_conj(npy_cfloat *a, npy_cfloat *r)
{
    r->real = a->real;
    r->imag = -a->imag;
    return;
...
static void
ncf_prod(npy_cfloat *a, npy_cfloat *b, npy_cfloat *r)
{
...
static void
ncf_quot(npy_cfloat *a, npy_cfloat *b, npy_cfloat *r)
{
    float ar=a->real, br=b->real, ai=a->imag, bi=b->imag;
    float d = br*br + bi*bi;
...
static void
ncf_sqrt(npy_cfloat *x, npy_cfloat *r)
{
    float s,d;
...
static void
ncf_log(npy_cfloat *x, npy_cfloat *r)
{
...
static void
ncf_log1p(npy_cfloat *x, npy_cfloat *r)
{
...
static void
ncf_exp(npy_cfloat *x, npy_cfloat *r)
{
    float a = expf(x->real);
...
static void
ncf_expm1(npy_cfloat *x, npy_cfloat *r)
{
    float a = expf(x->real);
...
static void
ncf_pow(npy_cfloat *a, npy_cfloat *b, npy_cfloat *r)
{
    npy_intp n;
    float ar=a->real, br=b->real, ai=a->imag, bi=b->imag;
...
static void
ncf_prodi(npy_cfloat *x, npy_cfloat *r)
{
    float xr = x->real;
    r->real = -x->imag;
    r->imag = xr;
...
static void
ncf_acos(npy_cfloat *x, npy_cfloat *r)
{
    npy_cfloat a, *pa=&a;
...
static void
ncf_acosh(npy_cfloat *x, npy_cfloat *r)
{
    npy_cfloat t, a, *pa=&a;
...
static void
ncf_asin(npy_cfloat *x, npy_cfloat *r)
{
    npy_cfloat a, *pa=&a;
    ncf_prodi(x, pa);
    ncf_prod(x, x, r);
...
static void
ncf_asinh(npy_cfloat *x, npy_cfloat *r)
{
    npy_cfloat a, *pa=&a;
    ncf_assign(x, pa);
    ncf_prod(x, x, r);
...
static void
ncf_atan(npy_cfloat *x, npy_cfloat *r)
{
    npy_cfloat a, *pa=&a;
    ncf_diff(&ncf_i, x, pa);
    ncf_sum(&ncf_i, x, r);
...
static void
ncf_atanh(npy_cfloat *x, npy_cfloat *r)
{
...
static void
ncf_cos(npy_cfloat *x, npy_cfloat *r)
{
...
static void
ncf_cosh(npy_cfloat *x, npy_cfloat *r)
{
    float xr=x->real, xi=x->imag;
...
static void
ncf_log10(npy_cfloat *x, npy_cfloat *r)
{
    ncf_log(x, r);
    r->real *= M_LOG10_E;
    r->imag *= M_LOG10_E;
...
static void
ncf_sin(npy_cfloat *x, npy_cfloat *r)
{
    float xr=x->real, xi=x->imag;
...
static void
ncf_sinh(npy_cfloat *x, npy_cfloat *r)
{
    float xr=x->real, xi=x->imag;
...
static void
ncf_tan(npy_cfloat *x, npy_cfloat *r)
{
    float sr,cr,shi,chi;
    float rs,is,rc,ic;
    float d;
...
static void
ncf_tanh(npy_cfloat *x, npy_cfloat *r)
{
    float si,ci,shr,chr;
    float rs,is,rc,ic;
    float d;
...
static void
ncf_abs(npy_cfloat *x, npy_cfloat *r)
{
